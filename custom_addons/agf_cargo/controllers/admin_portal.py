...
class AdminPortal(http.Controller):
    ...
    def detail_pesanan(self, kargo_id, **kwargs):
        ...
        return request.render('agf_cargo.admin_detail_pesanan_aktif', {'kargo': kargo})

    @http.route('/agf/admin/pesanan/baru', type='http', auth='user', website=True)
    def form_pesanan(self, **kwargs):
        batch_aktif = request.env['agf.batch'].search([('status', '=', 'aktif')], limit=1)
        return request.render('agf_cargo.admin_form_pesanan', {'batch_aktif': batch_aktif})
    ...
    def qr_management(self, **kwargs):
        ...
        return request.render('agf_cargo.admin_qr_code', {'tags': tags, 'stats': stats})
    ...
    def riwayat_batch(self, **kwargs):
        ...
        return request.render('agf_cargo.admin_riwayat_batch', {'batches': batches})
    ...
    def detail_batch(self, batch_id, **kwargs):
        ...
        if not batch.exists():
            return request.not_found()
        return request.render('agf_cargo.admin_detail_batch', {'batch': batch})
    ...
    def pengguna(self, **kwargs):
        ...
        return request.render('agf_cargo.admin_pengguna', {'users': users})
